...
data class JobExecutionData private constructor(
    ...
    companion object {
        ...
        fun buildWithParameters(jobName: String, jobBaseUrl: String, body: String): JobExecutionData {
            ...
            return create(jobName, jobBaseUrlWithSlash, "${jobBaseUrlWithSlash}buildWithParameters", body)
        }

        fun create(jobName: String, jobBaseUrl: String, jobTriggerUrl: String, body: String): JobExecutionData{
            val jobBaseUrlWithSlash = assureEndsWithSlash(jobBaseUrl)
            return JobExecutionData(jobName, jobBaseUrlWithSlash, jobTriggerUrl, body)
        }
